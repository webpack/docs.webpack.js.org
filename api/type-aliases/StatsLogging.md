...
[webpack](../globals) / StatsLogging

# Type Alias: StatsLogging

> **StatsLogging** = `KnownStatsLogging` & [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)<`string`, `any`>
