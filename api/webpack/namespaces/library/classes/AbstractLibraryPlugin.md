...
[webpack](../../../../globals) / [library](../index) / AbstractLibraryPlugin
...
[`Omit`](https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys)<`LibraryContext`<`T`>, `"options"`>
