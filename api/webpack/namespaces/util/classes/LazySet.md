...
[webpack](../../../../globals) / [util](../index) / LazySet
...
`LazySet`<`T`> | [`Iterable`](https://www.typescriptlang.org/docs/handbook/iterators-and-generators.html#iterable-interface)<`T`, `any`, `any`>
