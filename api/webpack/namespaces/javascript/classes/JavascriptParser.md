...
[webpack](../../../../globals) / [javascript](../index) / JavascriptParser
...
> `optional` **currentTagData**: [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)<`string`, `any`> | `CommonJsImportSettings` | `CompatibilitySettings` | `HarmonySettings` | `HarmonySpecifierGuards` | `ImportSettings` | [`TopLevelSymbol`](../../optimize/namespaces/InnerGraph/classes/TopLevelSymbol)
...
> `optional` **destructuringAssignmentProperties**: [`WeakMap`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WeakMap)<`Expression`, [`Set`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Set)<`DestructuringAssignmentProperty`>>
...
> `optional` **semicolons**: [`Set`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Set)<`number`>
...
> `static` **getImportAttributes**: (`node`) => [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)<`string`, `string`>
...
> `static` **VariableInfoFlags**: [`Readonly`](https://www.typescriptlang.org/docs/handbook/utility-types.html#readonlytype)<{ `Evaluated`: `0`; `Free`: `1`; `Normal`: `2`; `Tagged`: `4`; }>
...
> **destructuringAssignmentPropertiesFor**(`node`): [`Set`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Set)<`DestructuringAssignmentProperty`>
...
[`Set`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Set)<`DestructuringAssignmentProperty`>
...
> **getTagData**(`name`, `tag`): [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)<`string`, `any`> | `CommonJsImportSettings` | `CompatibilitySettings` | `HarmonySettings` | `HarmonySpecifierGuards` | `ImportSettings` | [`TopLevelSymbol`](../../optimize/namespaces/InnerGraph/classes/TopLevelSymbol)
...
[`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)<`string`, `any`> | `CommonJsImportSettings` | `CompatibilitySettings` | `HarmonySettings` | `HarmonySpecifierGuards` | `ImportSettings` | [`TopLevelSymbol`](../../optimize/namespaces/InnerGraph/classes/TopLevelSymbol)
...
> **errors**: [`Error`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Error) & `object`\[]

##### options

> **options**: [`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)<`string`, `any`>
